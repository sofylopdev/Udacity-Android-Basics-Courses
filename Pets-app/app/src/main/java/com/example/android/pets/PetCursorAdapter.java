...
public class PetCursorAdapter extends CursorAdapter {
    ...
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        // TOD: Fill out this method and return the list item view (instead of null)
...
// TOD: Fill out this method
        //populate list item with pet data
